  ...
  return (
    <div className="py-20 px-8 bg-primary text-textPrimary">
      <div className="text-center mb-12">
        <h1 className="text-5xl font-bold text-secondary">OUR MISSION</h1>
        <h2 className="text-4xl font-bold text-secondary">Redefining Radiology with AI</h2>
        <p className="mt-4 max-w-2xl mx-auto">
          At insightX, we are transforming radiology with cutting-edge AI technology, enabling faster, more accurate diagnoses and improved patient outcomes.
        </p>
      </div>

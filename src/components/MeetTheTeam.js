    ...
    <div className="bg-primary py-20 px-8 text-textPrimary">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        ...
        <div className="bg-primary p-6 rounded-lg shadow-lg hover:bg-accentGreen transition-all duration-300">
          ...
          <p className="mt-2">A visionary leader with extensive experience in healthcare technology, driving insightX's mission to transform radiology with AI.</p>
        </div>
        ...
        <div className="bg-primary p-6 rounded-lg shadow-lg hover:bg-accentGreen transition-all duration-300">
          ...
          <p className="mt-2">A specialist in AI algorithm development, leading the technical innovation at insightX.</p>
        </div>
